...
namespace System.Threading.Tasks
{
    ...
    {
        private static readonly Tasks.Task _defaultCompleted = FromResult<AsyncVoid>(default(AsyncVoid));
        ...
        /// </summary>
        internal static Tasks.Task Canceled()
        {
        ...
        /// </summary>        
        public static Tasks.Task Completed()
        {
        ...
        /// </summary>
        public static Tasks.Task FromError(Exception exception)
        {
        ...
        /// Returns an error task of the given type. The task is Completed, IsCanceled = False, IsFaulted = True
        /// </summary>
        public static Tasks.Task FromErrors(IEnumerable<Exception> exceptions)
        {
        ...
        public static Tasks.Task RunSynchronously(Action action, CancellationToken token = default(CancellationToken))
        {
