...
namespace System.Threading.Tasks
{
    public static class TaskHelpersExtensions
    {
        ...
        private static readonly Action<Tasks.Task> _rethrowWithNoStackLossDelegate = GetRethrowWithNoStackLossDelegate();
        ...
        /// </summary>
        internal static Tasks.Task Catch(this Tasks.Task task, Func<CatchInfo, CatchInfo.CatchResult> continuation, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        private static Task<TResult> CatchImpl<TResult>(this Tasks.Task task, Func<Task<TResult>> continuation, CancellationToken cancellationToken)
        {
        ...
        private static Task<TResult> CatchImplContinuation<TResult>(Tasks.Task task, Func<Task<TResult>> continuation)
        {
        ...
        /// </summary>
        internal static Tasks.Task CopyResultToCompletionSource<TResult>(this Tasks.Task task, TaskCompletionSource<TResult> tcs, TResult completionResult)
        {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        internal static Tasks.Task CopyResultToCompletionSource<TResult>(this Task<TResult> task, TaskCompletionSource<TResult> tcs)
        {
            return task.CopyResultToCompletionSourceImpl(tcs, innerTask => innerTask.Result);
        }

        private static Tasks.Task CopyResultToCompletionSourceImpl<TTask, TResult>(this TTask task, TaskCompletionSource<TResult> tcs, Func<TTask, TResult> resultThunk)
            where TTask : Tasks.Task
        {
            // Stay on the same thread if we can
            if (task.IsCompleted)
            {
        ...
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        private static Tasks.Task CopyResultToCompletionSourceImplContinuation<TTask, TResult>(TTask task, TaskCompletionSource<TResult> tcs, Func<TTask, TResult> resultThunk)
            where TTask : Tasks.Task
        {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        internal static Task<object> CastToobject(this Tasks.Task task)
        {
            // Stay on the same thread if we can
            if (task.IsCompleted)
            {
        ...
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        internal static Tasks.Task FastUnwrap(this Task<Tasks.Task> task)
        {
            Tasks.Task innerTask = task.Status == TaskStatus.RanToCompletion ? task.Result : null;
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "The caught exception type is reflected into a faulted task.")]
        internal static Tasks.Task Finally(this Tasks.Task task, Action continuation, bool runSynchronously = false)
        {
            // Stay on the same thread if we can
            if (task.IsCompleted)
            {
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "The caught exception type is reflected into a faulted task.")]
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        private static Task<TResult> FinallyImplContinuation<TResult>(Tasks.Task task, Action continuation, bool runSynchronously = false)
        {
            SynchronizationContext syncContext = SynchronizationContext.Current;
        ...
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        private static Action<Tasks.Task> GetRethrowWithNoStackLossDelegate()
        {
#if NETFX_CORE
            return task => task.GetAwaiter().GetResult();
#else
            MethodInfo getAwaiterMethod = typeof(Tasks.Task).GetMethod("GetAwaiter", Type.EmptyTypes);
            if (getAwaiterMethod != null)
            {
                ...
                var taskParameter = Expression.Parameter(typeof(Tasks.Task));
                ...
                var lambda = Expression.Lambda<Action<Tasks.Task>>(getResultCall, taskParameter);
        ...
        private static void MarkExceptionsObserved(this Tasks.Task task)
        {
        ...
        /// </summary>
        public static Tasks.Task Then(this Tasks.Task task, Action continuation, CancellationToken cancellationToken = default(CancellationToken), bool runSynchronously = false)
        {
        ...
        /// to completion (i.e., was not cancelled and did not fault).
        /// </summary>
        public static Task<TOuterResult> Then<TOuterResult>(this Tasks.Task task, Func<TOuterResult> continuation, CancellationToken cancellationToken = default(CancellationToken), bool runSynchronously = false)
        {
        ...
        /// to completion (i.e., was not cancelled and did not fault).
        /// </summary>
        public static Tasks.Task Then(this Tasks.Task task, Func<Tasks.Task, Tasks.Task> continuation, CancellationToken cancellationToken = default(CancellationToken), bool runSynchronously = false)
        {
            return task.Then(() => continuation(task).Then(() => default(AsyncVoid)), cancellationToken, runSynchronously);
        }
        ...
        /// to completion (i.e., was not cancelled and did not fault).
        /// </summary>
        public static Task<TOuterResult> Then<TOuterResult>(this Tasks.Task task, Func<Task<TOuterResult>> continuation, CancellationToken cancellationToken = default(CancellationToken), bool runSynchronously = false)
        {
            return task.ThenImpl(t => continuation(), cancellationToken, runSynchronously);
        }
        public static Tasks.Task Then<TInnerResult>(this Task<TInnerResult> task, Func<Tasks.Task> continuation, CancellationToken cancellationToken = default(CancellationToken), bool runSynchronously = false)
        {
            return task.ThenImpl(t => continuation(), cancellationToken, runSynchronously);
        }
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        public static Tasks.Task Then<TInnerResult>(this Task<TInnerResult> task, Action<TInnerResult> continuation, CancellationToken cancellationToken = default(CancellationToken), bool runSynchronously = false)
        {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        public static Task<TOuterResult> Then<TInnerResult, TOuterResult>(this Task<TInnerResult> task, Func<TInnerResult, TOuterResult> continuation, CancellationToken cancellationToken = default(CancellationToken), bool runSynchronously = false)
        {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        public static Tasks.Task Then<TInnerResult>(this Task<TInnerResult> task, Func<TInnerResult, Tasks.Task> continuation, CancellationToken token = default(CancellationToken), bool runSynchronously = false)
        {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        public static Task<TOuterResult> Then<TInnerResult, TOuterResult>(this Task<TInnerResult> task, Func<TInnerResult, Task<TOuterResult>> continuation, CancellationToken cancellationToken = default(CancellationToken), bool runSynchronously = false)
        {
            return task.ThenImpl(t => continuation(t.Result), cancellationToken, runSynchronously);
        }

        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "The caught exception type is reflected into a faulted task.")]
        internal static Task<TOuterResult> ThenImpl<TTask, TOuterResult>(this TTask task, Func<TTask, Task<TOuterResult>> continuation, CancellationToken cancellationToken, bool runSynchronously)
            where TTask : Tasks.Task
        {
            // Stay on the same thread if we can
            if (!task.IsCompleted) return ThenImplContinuation(task, continuation, cancellationToken, runSynchronously);
        ...
        internal static Tasks.Task ThenImpl<TTask>(this TTask task, Func<TTask, Tasks.Task> continuation, CancellationToken cancellationToken, bool runSynchronously)
            where TTask : Tasks.Task
        {
            // Stay on the same thread if we can
            if (!task.IsCompleted) return ThenImplContinuation(task, continuation, cancellationToken, runSynchronously);
            ...
            if (task.IsFaulted)
            {
                return TaskHelpers.FromErrors(task.Exception.InnerExceptions);
            }
            if (task.IsCanceled || cancellationToken.IsCancellationRequested)
            {
        ...
        private static Tasks.Task ThenImplContinuation<TTask>(TTask task, Func<TTask, Tasks.Task> continuation, CancellationToken cancellationToken, bool runSynchronously = false)
            where TTask : Tasks.Task
        {
            SynchronizationContext syncContext = SynchronizationContext.Current;

            var tcs = new TaskCompletionSource<Tasks.Task>();
        ...
        private static Task<TOuterResult> ThenImplContinuation<TOuterResult>(Tasks.Task task, Func<Task<TOuterResult>> continuation, CancellationToken cancellationToken, bool runSynchronously = false)
        {
            SynchronizationContext syncContext = SynchronizationContext.Current;
        ...
        /// </summary>
        internal static void ThrowIfFaulted(this Tasks.Task task)
        {
        ...
        /// </summary>
        internal static Task<TResult> ToTask<TResult>(this Tasks.Task task, CancellationToken cancellationToken = default(CancellationToken), TResult result = default(TResult))
        {
            if (task == null)
            {
                return null;
            ...
            // Stay on the same thread if we can
            if (!task.IsCompleted) return ToTaskContinuation(task, result);
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "The caught exception type is reflected into a faulted task.")]
        [SuppressMessage("Microsoft.Web.FxCop", "MW1201:DoNotCallProblematicMethodsOnTask", Justification = "The usages here are deemed safe, and provide the implementations that this rule relies upon.")]
        private static Task<TResult> ToTaskContinuation<TResult>(Tasks.Task task, TResult result)
        {
    ...
    [SuppressMessage("Microsoft.StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass", Justification = "Packaged as one file to make it easy to link against")]
    internal class CatchInfo : CatchInfoBase<Tasks.Task>
    {
        private static CatchResult _completed = new CatchResult { Task = TaskHelpers.Completed() };

        public CatchInfo(Tasks.Task task)
            : base(task)
        {
        }
        ...
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", Justification = "This would result in poor usability.")]
        public CatchResult Task(Tasks.Task task)
        {
